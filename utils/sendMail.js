...
module.exports = async (options, templatePath = null) => {
  ...
  templatePath = templatePath || __dirname + "./mailTemplates/applicationReceived.html";

  // Read and customize the email template
  let emailTemplate = fs.readFileSync(templatePath, "utf8");
  
  // Replace placeholder for customer name
  emailTemplate = emailTemplate.replace("{{customerName}}", options.customerName || "Valued Customer");
  ...
  const mailOptions = {
    ...
    text: options.text || "We have received your request and will contact you soon.",
    html: emailTemplate,
  };
